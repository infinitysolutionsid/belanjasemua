                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    ...
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">
                                                            ...
                                                            Kisaran Hargaa: {{$order->kisaran_harga}} <br>
                                                            ...
                                                            Ayo kita selesaikan Order #{{$order->id}} dan jangan tunda
                                                            tunda lagi!.
                                                        </span>
                                                    </p>
                                                </div>
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style=""><strong>Terima kasih.</strong><br>
                                                            belanjasemua.com System <br>
                                                            support@belanjasemua.com <br></span></p>
                                                </div>
                                            </div>
                                            <div
                                                style="font-family:Helvetica, sans-serif;padding-top:10px;padding-right:30px;padding-bottom:10px;padding-left:30px;">
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <small class="text-muted">Anda menerima email ini sebagai
                                                        pemberitahuan
                                                        tentang adanya
                                                        order baru dalam sistem belanjasemua.com</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
