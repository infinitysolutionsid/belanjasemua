@extends('welcome')
@section('titlepage','Euro UPVC - Window System Catalog')
<?php $y = Date('Y'); ?>
@section('deschomepage','Katalog Window System milik Euro uPVC memiliki banyak kelebihan, salah satunya adalah
jaminan garansi yang memiliki rentang waktu garansi yang lama. Tunggu apa lagi? Langsung konsultasi dengan kami.')
@section('content')
<section id="page-title" class="page-title-left text-light" data-bg-parallax="{!!asset('images/katalog/window.jpg')!!}">
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="heading-text heading-section text-left mt-3">
                    <h1 style="color:#cb2027">Katalog Jendela</h1>
            ...
            <div class="col-lg-6"> <img class="img-fluid" src="{!!asset('images/katalog/window-system.png')!!}">
            </div>
        </div>
        <div class="row align-items-center">
            <div class="col-lg-12">
...
<div style="background-image:url({!!asset('images/katalog/calltoac.png')!!})"
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <h3 class="text-light">
                    Tertarik dengan produk jendela uPVC kami? Butuh konsultasi untuk mempercantik rumah anda?
                </h3>
                <p class="text-light">
            ...
            <div class="col-lg-4">
                <a href="https://api.whatsapp.com/send?phone=6282267673000&text=Halo%20Euro%20uPVC%2C%20saya%20tertarik%20dengan%20produk%20Window%20System%20uPVC%20milik%20Euro%20uPVC..%20Boleh%20ngobrol%3F"
